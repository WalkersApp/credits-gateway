...
export const FUNDING_ROUTES: FundingRoute[] = [
  {
    ...
    asset: "USDC",
    assetDecimals: 6,
    provider: "Circle testnet USDC, read over a public Sepolia JSON-RPC node",
  ...
  },
  {
    ...
    asset: "tADA",
    assetDecimals: 6,
    provider: "Cardano preprod, read via Koios",
    verification: "onchain_automatic",
  ...
  },
  {
    ...
    asset: "USDCx (preprod)",
    assetDecimals: 6,
    provider: "Cardano preprod native asset, read via Koios",
    verification: "onchain_automatic",
    confirmationsRequired: config.cardanoDeposits.confirmations,
    depositAddress: config.cardanoDeposits.address || null,
    contract: usdcxUnit,
  ...
  },
  {
    ...
    asset: "USDC / USDT",
    assetDecimals: 6,
    provider: "Manual — no exchange API is integrated",
